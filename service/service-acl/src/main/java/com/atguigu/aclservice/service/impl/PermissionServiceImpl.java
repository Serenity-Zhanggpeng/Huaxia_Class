 ...
 * @author testjava
 * @since 2020-01-12
 * permissionList 所有的一级菜单对象   permissionNode:遍历出的一级菜单对象
 * finalNode:最终封装的菜单list集合   注意菜单表只有一个 id和pid id=pid的说明自己就是一个子菜单
 * 当pid=0的一行，是一级菜单
 *
 *
 */
...
//        });
    ...
    //把返回所有菜单list集合进行封装的方法 参数是所有的菜单list集合(按照降序排序的)
    public static List<Permission> bulidPermission(List<Permission> permissionList) {

        //创建list集合，finaLode用于数据最终封装
        ...
        for(Permission permissionNode : permissionList) {
            ...
            if("0".equals(permissionNode.getPid())) {
                ...
                //根据顶层菜单，向里面进行查询子菜单，封装到finalNode里面  递归
